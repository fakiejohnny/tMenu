...
function () {
  function Menu(options) {
    ...
    delete _hammerjs.default.defaults.cssProps.userSelect;
    this.hammerBody = new _hammerjs.default(body);
    this.hammerNav = new _hammerjs.default(nav);
    this.hammerIcon = new _hammerjs.default(icon);
    this.hammerFilter = new _hammerjs.default(filter);
    this.translateX = 0;
    this.saturation = 0;
    this.overhang = 0;
    this.navWidth = 0;
    ...
    this.options = _objectSpread({}, this.optionsDefault, options);
    ...
    var _loop = function _loop(i) {
      _this.drop[i].addEventListener("click", function () {
        _this.drop[i].classList.toggle("d-active");
...
},{"hammerjs":"../node_modules/hammerjs/hammer.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var m = new _menu.default({
  overhangPercent: 0
});
},{"./menu":"menu.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
